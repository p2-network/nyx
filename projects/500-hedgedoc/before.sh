...
echo "TZ=Australia/Melbourne" >> hedgedoc.env
echo "CMD_DB_URL=postgres://${DOCKER_HEDGEDOC_DB_USER}:${DOCKER_HEDGEDOC_DB_PASSWORD}@database:5432/${DOCKER_HEDGEDOC_DB}" > app.env
echo "CMD_DOMAIN=hedgedoc.nyx.thepatrick.cloud" >> hedgedoc.env
echo "CMD_URL_ADDPORT=false" >> hedgedoc.env
echo "CMD_PROTOCOL_USESSL=false" >> hedgedoc.env
echo "CMD_PORT=3000" >> hedgedoc.env
echo "CMD_ALLOW_ORIGIN=['hedgedoc.nyx.thepatrick.cloud']" >> hedgedoc.env
